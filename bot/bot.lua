bot = dofile('/gssd/inline/data/utils.lua')
json = dofile('/gssd/inline/data/JSON.lua')
...
BASE = '/gssd/inline/bot/'
SUDO = 315017219 --sudo id
sudo_users = {315017219,317576202,Userid}
BOTS = 394509436 --bot id
