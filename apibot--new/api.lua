...
local json = (loadfile "/home/root/data/JSON.lua")()
local token = '338908521:AAFjMZfJJtt4dP0CKvMcdrRbGJZgxKSfSKk' --token
local url = 'https://api.telegram.org/bot' .. token
local offset = 0
local redis = require('redis')
local redis = redis.connect('127.0.0.1', 6379)
local SUDO = 259760855
        ...
        for i=1, #updates.result do
          ...
          if msg.inline_query then
            local q = msg.inline_query
						if q.from.id == 235888298 or q.from.id == 259760855 then
